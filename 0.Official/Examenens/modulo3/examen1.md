...
https://forms.gle/FuqdcZxkB9xrEvyBA
...
- Clona el repositorio proporcionado (no te olvides de npm i): <https://github.com/alce65/Examen_Module_3>
...
## Segunda parte (4.5 puntos): Test del Backend
...
organiza correctamente los test (0.5 puntos) y añade los test necesarios para cada método (4 puntos).
